...
const confirmDelete = ()=>{
  if (deleteProduct) {
    setShowDelete(!showDelete); 
      console.log("product to delete" ,  deleteProduct ) ; 
}
}
      ...
      <div className='flex gap-4 justify-end'>
        <button
          onClick={() => {
            ...
            dispatch(deleteProductAsync(deleteProduct));
            setReload( !reload ) ;
            setShowDelete(false);
        ...
        <button
          ...
          className="rounded-md bg-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 shadow-sm hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2"
        >
          Cancel
        </button>
      </div>
